...
import Image1 from "../../assets/Services/Standupindia.webp";
import {
  Mail,
  User,
  Phone,
    ...
    <Mainlayout>
      ...
      >
        <div className="w-full max-w-[1920px] mx-auto space-y-6">
          <h2 className="sub-heading bg-gradient-to-t text-center font-1 bg-clip-text from-[#3CA2E2] to-[#052EAA] text-transparent">
