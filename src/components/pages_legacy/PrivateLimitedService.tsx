...
import Image1 from "../../assets/Services/PvtLtd.webp";
import {
  Mail,
  User,
  Phone,
        ...
        >
          ...
          >
            ...
            <div className="w-full flex items-center justify-center p-8">
              <img src={Image1.src} alt="Private Limited Company Registration in India" className="w-full h-auto rounded-4xl object-contain shadow-2xl" loading="lazy" />
            </div>
          </motion.div>
            </div>
          </div>
