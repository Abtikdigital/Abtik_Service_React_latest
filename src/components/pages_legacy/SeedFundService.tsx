...
import Image1 from "../../assets/Services/SeedFund.webp";
import {
 Mail,
 User,
 Phone,
     ...
     <div className="w-full max-w-[1920px] mx-auto px-7 md:px-14 flex flex-col md:flex-row gap-8 box-border">
      ...
      >
       ...
       <div className="w-full h-full flex items-center justify-center p-8">
              <img src={Image1.src} alt="Startup India Seed Fund Scheme Illustration" className="w-full h-auto rounded-4xl object-contain shadow-2xl" loading="lazy" />
            </div>
      </motion.div>
     </div>
    </motion.section>
