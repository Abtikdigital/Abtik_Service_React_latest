...
const CMEGP = () => {
  ...
  // Abtik Startup Advisor pvt ltd Team Process
  ...
  return (<>
    ...
    <Mainlayout>
      ...
      >
        ...
        >
          How Abtik Startup Advisor pvt ltd Team Helps You Get CMEGP Subsidy
        </h2>
      ...
      >
        ...
        >
          Why Choose Abtik Startup Advisor pvt ltd Team for CMEGP
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-12">
      ...
      >
        <div className="w-full max-w-[1920px] mx-auto space-y-6">
          <h2 className="sub-heading bg-gradient-to-t font-2 text-center bg-clip-text from-[#3CA2E2] to-[#052EAA] text-transparent">
