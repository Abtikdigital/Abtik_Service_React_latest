...
import Image1 from "../../assets/Services/Projectfunding.webp";
import {
  Mail,
  User,
  Phone,
          ...
          <div className="flex flex-col justify-evenly flex-grow">
            ...
            >
              ...
              <div>
                ...
                <p className="text-xs font-3 text-gray-600">+91 89281 38434</p>
              </div>
            </a>
            <a
            ...
            >
              ...
              <div>
                ...
                <p className="text-xs font-3 text-gray-600">info@abtikservices.com</p>
              </div>
            </a>
          </div>
        </motion.div>
