...
import Image1 from "../../assets/Services/NbfcLoan.webp";
import {
  Mail,
  User,
  Phone,
    ...
    <>
      ...
      <Mainlayout>
       ...
       <motion.div
        ...
        >
          <h2 className="sub-heading font-3 bg-gradient-to-t text-center bg-clip-text from-[#3CA2E2] to-[#052EAA] text-transparent"
