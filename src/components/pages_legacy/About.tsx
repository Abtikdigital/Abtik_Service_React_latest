...
const About = () => {
 ...
 useEffect(() => {
  const updateCols = () => {
    setVisionCols(typeof window !== 'undefined' && window.innerWidth >= 768 ? 2 : 1);
  };
  updateCols();
 ...
 useEffect(() => {
  const updateCols = () => {
    setWhyChooseCols(typeof window !== 'undefined' && window.innerWidth >= 768 ? 2 : 1);
  };
  updateCols();
  window.addEventListener("resize", updateCols);
  return () => window.removeEventListener("resize", updateCols);
   ...
   <Mainlayout>
    ...
    >
     ...
     "
        ...
        <div>
         {index == 0 ? (
          <img loading="lazy" src={Image2.src} className="rounded-4xl max-h-96 w-full" />
         ) : (
          <img loading="lazy" src={Image3.src} className="rounded-4xl max-h-96 w-full" />
         )}
        </div>
       </motion.div>
      ))}
    ...
    >
     ...
     "
         ...
         <>
          <div>
           <img loading="lazy" src={WhychooseImage1.src} className="rounded-4xl w-full h-auto" />
          </div>
          <div>
           <img loading="lazy" src={WhychooseImage2.src} className="rounded-4xl w-full h-auto" />
          </div>
          <div className="md:col-span-2">
           <img loading="lazy" src={WhychooseImage3.src} className="rounded-4xl w-full h-auto" />
          </div>
         </>
        )}
       </motion.div>
