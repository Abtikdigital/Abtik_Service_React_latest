import Budget1Img from "../assets/NewBlog/Budget1.jpg";
import StartupImg from "../assets/NewBlog/Startup.jpg";
import Image2Img from "../assets/NewBlog/Image2.jpg";
import BusinessWomenImg from "../assets/NewBlog/BussinessWomen.jpg";
import BusinessRegistrationImg from "../assets/NewBlog/BusinessRegistrationMadeSimple.jpg";
import BusinessRegistrationSmallImg from "../assets/NewBlog/SmallSizeBusinessRegistrationMadeSimple.jpg";
import FundingImg from "../assets/NewBlog/Article2.jpg";
import TrademarkIpImg from "../assets/NewBlog/TrademarkIpImage.jpg";
import MsmeRoadmapImg from "../assets/NewBlog/Article8.jpeg";
import TaxComplianceImg from "../assets/NewBlog/Article9.jpg";
import FssaiImg from "../assets/NewBlog/Fassai.jpg";
...
export interface BlogData {
  title: string;
  /**
   * Short description used in the `NewBlog` cards (optional).
   * If not provided, UI will fall back to `description`.
   */
  cardDescription?: string;
  /**
   * Optional card image (thumbnail). If not provided, UI will use `img`.
   */
  cardImg?: string;
  /**
   * Full description used in the expanded blog page.
   */
  description: string;
  img: string;
  slug: string;
  ...
  list: BlogListItem[];
  /**
   * Controls whether it appears on `/blogs` list section (`NewBlog`).
   * Defaults to `true`.
   */
  showInNewBlogList?: boolean;
}

/**
 * Single source of truth for:
 * - `src/section/NewBlog.tsx` cards
 * - `src/pages/ExpandedBlog.tsx` expanded content
 *
 * Make changes here once and it reflects everywhere.
 */
export const blogsData: BlogData[] = [
    ...
    list: [
      {
        ...
        description: "Most failures happen due to lack of systems, not lack of intent.",
      },
      {
        ...
        description: "A strong framework turns compliance from a burden into an advantage.",
      },
      {
        ...
        description: "Automation and monthly reconciliation prevent common GST issues.",
      },
      {
        ...
        description: "Timely deposits and certificates keep vendor relationships smooth.",
      },
      {
        ...
        description: "Maintain a single calendar for all annual and event-based filings.",
      },
      {
        ...
        description: "Choose the right regime and ensure all eligible claims are taken.",
      },
      {
        title: "The Real Cost of Non-Compliance",
        lists: ["A ₹2 crore MSME can lose ₹3–5 lakhs annually in penalties and interest"],
      ...
      },
      {
        ...
        description: "Turn compliance into a competitive advantage in 12 weeks.",
      },
      {
        title: "Bottom Line",
        lists: [
        ...
        description: "Adopt systems now to prevent penalties and unlock growth.",
      },
    ],
  },

  // Not currently shown on the NewBlog card grid (but still accessible by URL).
  {
    title:
  ...
  {
    title: "Unlocking Growth: A Complete Guide to Funding Solutions for Indian MSMEs in 2025",
  ...
  },
  {
    title:
      "Business Registration Made Simple: Choose the Right Structure to Maximize Growth & Minimize Risk",
    cardDescription: "Beyond big cities and large companies, Budget 2025 has acknowledged...",
    ...
    list: [
      {
        ...
        description: "For years, MSMEs have demanded more than just recognition...",
      },
      {
    ...
    list: [
      {
        ...
        lists: [],
        description: "New initiatives for solar powered equipment, cold storage...",
      },
      {
