    ...
    const faq = [
        {
            ...
            answer: "A Section 8 Company is a registered non-profit under the Companies Act, 2013, formed for charitable, educational, social, research, or environmental purposes. All profits/surplus must be used for the objects of the company; no dividend is paid to members."
        },
        {
            question: "2. Who can register a Section 8 Company?",
            answer: "Individuals or associations aiming for a non-profit goal—minimum 2 directors (Pvt Ltd) or 3 (Public Ltd)—with valid IDs and digital signatures."
        },
        {
            question: "3. What are the main benefits?",
            answer: "Legal recognition, grant/donor/CSR eligibility, tax exemption (post 12A/80G registration), enhanced credibility, perpetual succession, and limited liability for members."
        },
        {
            question: "4. What documents are needed?",
            answer: "DSC (Digital Signature), DIN (Director ID), promoters' ID/address proof, registered address proof, Memorandum/Articles with clear non-profit objectives, MCA declarations/consents."
        },
        {
            question: "5. What is the registration process?",
            answer: "Obtain DSC and DIN, draft and file MOA/AOA, apply and get Section 8 Central Govt. license via MCA portal (SPICe+/INC-12), and receive Certificate of Incorporation, PAN, TAN. All steps are digital."
        },
        {
            question: "6. How does Abtik help?",
            answer: "Abtik drafts all required documents, procures DSCs, manages online filings and follow-ups, obtains MCA Section 8 license, and assists post-registration with tax and donor compliance."
        }
    ];
    ...
    const processData = [
        {
            ...
            description: "We obtain DSCs and DINs for all promoters—enabling secure, compliant e-filings."
        },
        {
            icon: Shield,
            title: "Draft Memorandum & Online Application",
            description: "Prepare MOA/AOA and detailed Section 8 documents, then file SPICe+ and INC-12 on MCA portal to get license."
        },
        {
            icon: Award,
            title: "Approval, Certificate & Tax Setup",
            description: "Receive your Certificate of Incorporation, PAN/TAN, and post-reg help for 12A/80G and CSR/funding compliance."
        }
    ];
    ...
    const benefitsData = [
        {
            ...
            description: "Section 8 status is the gold standard for NGOs/charities—trusted by donors and regulators."
        },
        {
            icon: DollarSign,
            title: "Funding and Tax Benefits",
            description: "Eligible for major grants, donor gifts, CSR, and (after 12A/80G) tax-exempt income or donations."
        },
        {
            icon: Shield,
            title: "Legal & Perpetual Existence",
            description: "Limited liability, perpetual succession, and clear exit/admission rules for directors/members."
        },
        {
            icon: Users,
            title: "Easy National/International Operations",
            description: "Pan-India work, bank accounts, FCRA eligibility, and superior credibility over trusts/societies."
        },
        {
            icon: Award,
            title: "High Donor & CSR Trust",
            description: "Compliance-ready, transparent e-filings, and best-suited for CSR, NGO grant, and government partnerships."
        }
    ];
