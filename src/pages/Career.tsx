   ...
   <Mainlayout>
    ...
    >
     <div className="w-full max-w-[1920px] mx-auto">
      ...
      >
       Job Openings at Abtik Startup Advisor pvt ltd Team
      </h2>
