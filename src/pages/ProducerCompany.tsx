...
const ProducerCompanyRegistration = () => {
    ...
    const faq = [
        ...
        },
        {
            ...
            answer: "Any ten or more individual producers (farmers, artisans, or agri-entrepreneurs), or two or more producer institutions (like societies/cooperatives) can jointly set up a Producer Company."
        },
        {
            question: "3. What are the key benefits?",
            answer: "Full corporate status, limited liability, collective marketing and procurement, eligibility for NABARD/central/state subsidies, Income Tax benefits for agriculture income, and preferred access to government schemes, grants, and credit."
        },
        {
            question: "4. What documents are needed?",
            answer: "PAN/Aadhaar and address proofs of directors and members, proof of business address, passport photos, landholding/birth/occupation proof (for farmer/producer status), and incorporation-related documents (MOA/AOA)."
        },
        {
            question: "5. How long does it take to register a Producer Company?",
            answer: "With all documents ready, registration usually completes in 10–20 working days, including digital signatures, company name approval, and submission/approval of all MCA forms."
        },
        {
            question: "6. How does Abtik help Producer Companies?",
            answer: "Abtik provides complete legal and compliance help—document vetting, digital signatures, drafting, member coordination, online MCA filing, and end-to-end handholding for government schemes, GST, bank loans, and annual returns."
        }
    ];
    ...
    const processData = [
        {
            ...
            description: "We review all farmer/member docs, ensure eligibility, and prepare necessary digital signatures and KYC."
        },
        {
            icon: Shield,
            title: "MOA/AOA Drafting & Filing",
            description: "Draft Producer Company-specific Memorandum/Articles and file with MCA, along with all member forms."
        },
        {
            icon: Award,
            title: "Certificate & Post Incorporation",
            description: "Deliver Certificate of Incorporation, PAN, TAN, and assist in opening company bank account and registrations (like FPO, GST, etc)."
        }
    ];
    ...
    const benefitsData = [
        {
            ...
            description: "Farmers, artisans, or producers can pool resources for better market prices, procurement, and bargaining."
        },
        {
            icon: DollarSign,
            title: "Loans, Subsidies, Grants",
            description: "Easy access to NABARD, SFAC, and government schemes, plus preference in agri-business loans."
        },
        {
            icon: Shield,
            title: "Limited Liability",
            description: "Members are protected—liability is restricted to shares; personal risk is minimized."
        },
        {
            icon: Users,
            title: "Tax Benefits",
            description: "Special tax status for agri/producer companies; agri income may be exempt; corporate income can be optimized under law."
        },
        {
            icon: Award,
            title: "Perpetual Legitimate Existence",
            description: "Legal structure survives change in membership; continuous operations guaranteed by the Companies Act."
        }
    ];
                     ...
                     <div className="space-y-4">
                        ...
                        >
                            ...
                            <div>
                                ...
                                <p className="text-xs text-gray-600"><a href="tel:+919898043284">+91 9898 043 284</a></p>
                            </div>
                        </a>
                        <a
                        ...
                        <motion.div initial={{ y: 50, opacity: 0 }}
                            ...
                            <ul className="space-y-2 text-sm text-gray-600">
                                <li className="grid grid-cols-[20px_1fr] gap-2 items-start">
                                    ...
                                    <span>Minimum 10 individuals (all must be producers by occupation)</span>
                                </li>
                                <li className="grid grid-cols-[20px_1fr] gap-2 items-start">
                                    <CheckCircle className="w-5 h-5 text-[#3CA2E2]" />
                                    <span>OR 2 producer organizations/institutions (e.g. cooperative societies)</span>
                                </li>
                                <li className="grid grid-cols-[20px_1fr] gap-2 items-start">
                                    <CheckCircle className="w-5 h-5 text-[#3CA2E2]" />
                                    <span>Registered office in India, local address proof required</span>
                                </li>
                                <li className="grid grid-cols-[20px_1fr] gap-2 items-start">
                                    <CheckCircle className="w-5 h-5 text-[#3CA2E2]" />
