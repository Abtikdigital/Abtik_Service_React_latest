...
const FSSAILicense = () => {
  ...
  // Why Choose Abtik Startup Advisor pvt ltd Team
  ...
  // === Why Choose Abtik Startup Advisor pvt ltd Team Cards ===
  const whyChooseData = [
    {
      icon: Shield,
  ...
  return (
    <>
      <HeadProvider>
        <Title>
          {seoData?.fssaiLicenseService?.title ||
            "FSSAI License Registration Get Food License Online | Abtik Startup Advisor pvt ltd Team"}
        </Title>
        <Meta
          name="description"
          content={
            seoData?.fssaiLicenseService?.description ||
            "Get FSSAI License registration online with Abtik Startup Advisor pvt ltd Team. Expert assistance for Basic Registration, State License & Central License. Fast approval, complete documentation support."
          }
        />
        <Meta
          name="keywords"
      ...
      <Mainlayout>
        ...
        >
          ...
          <div className="bg-gradient-to-t from-[#3CA2E2] to-[#052EAA] rounded-4xl p-8 md:p-12 space-y-4 text-center">
            ...
            <p className="paragraph font-3 !text-white mx-auto text-left">
              ...
              Abtik Startup Advisor pvt ltd Team handle your FSSAI license application process with expert
        ...
        {/* Abtik Startup Advisor pvt ltd Team Process Section */}
        <motion.section
          ref={refProcess}
          initial={{ y: 100, opacity: 0 }}
        ...
        >
          <div className="w-full max-w-[1920px] mx-auto px-7 md:px-14">
          <h2 className="sub-heading font-2 text-center bg-gradient-to-t text-transparent bg-clip-text from-[#3CA2E2] to-[#052EAA]">
            How Abtik Startup Advisor pvt ltd Team Helps with FSSAI License
          </h2>
        ...
        {/* Why Choose Abtik Startup Advisor pvt ltd Team Section */}
        <motion.section
          ref={refWhyChoose}
          initial={{ y: 100, opacity: 0 }}
        ...
        >
          <div className="w-full max-w-[1920px] mx-auto px-7 md:px-14">
          <h2 className="sub-heading font-2 text-center bg-gradient-to-t text-transparent bg-clip-text from-[#3CA2E2] to-[#052EAA]">
            Why Choose Abtik Startup Advisor pvt ltd Team for FSSAI License
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-12">
