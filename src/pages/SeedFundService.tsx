...
const SeedFund = () => {
    ...
    const faq = [
        ...
        {
            question: "6. What are the eligibility criteria for government seed funding?",
            answer:
    ...
    const isInViewFundBenefits = useInView(refFundBenefits, { once: true, amount: 0.1 });
    ...
    return (<>
        ...
        <Mainlayout>
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        through every step of the funding process.
                    </p>
            ...
            >
                <div className="bg-gradient-to-t from-[#3CA2E2] to-[#052EAA] rounded-4xl p-8 md:p-12 space-y-4 text-center">
                    ...
                    >
                        ...
                        funding is crucial for product development, market research, team building,
                        and establishing the foundation for future growth and larger investment rounds.
                    </p>
                </div>
            </motion.section>
                        ...
                        >
                            ...
                            <div className="text-center mb-4">
                                ...
                                <div className="bg-gradient-to-r from-[#052EAA] to-[#3CA2E2] text-white p-3 rounded-xl">
                                    <p className="text-2xl font-bold  font-3  ">Up to ₹20 Lakh</p>
                                    <p className="text-xs opacity-90 font-3">Maximum grant amount</p>
                                </div>
                            </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        >
                            ...
                            <ul className="space-y-2 text-sm text-gray-600 font-3">
                                <li className="grid grid-cols-[20px_1fr] gap-2 items-start">
                                    <CheckCircle className="w-5 h-5 text-[#3CA2E2]" />
                                    <span>Essential capital for product development and market validation.</span>
                                </li>
                                <li className="grid grid-cols-[20px_1fr] gap-2 items-start">
                                    <CheckCircle className="w-5 h-5 text-[#3CA2E2]" />
                                ...
                                <li className="grid grid-cols-[20px_1fr] gap-2 items-start">
                                    <CheckCircle className="w-5 h-5 text-[#3CA2E2]" />
                                    <span>Business validation and credibility in the market.</span>
                                </li>
                                <li className="grid grid-cols-[20px_1fr] gap-2 items-start">
                                    <CheckCircle className="w-5 h-5 text-[#3CA2E2]" />
                                    <span>Strategic guidance for business growth and scaling.</span>
                                </li>
                                <li className="grid grid-cols-[20px_1fr] gap-2 items-start">
                                    <CheckCircle className="w-5 h-5 text-[#3CA2E2]" />
                        ...
                        >
                            ...
                            <ul className="space-y-2 text-sm text-gray-600 font-3">
                                ...
                                <li className="grid grid-cols-[20px_1fr] gap-2 items-start">
                                    <CheckCircle className="w-5 h-5 text-[#3CA2E2]" />
                                    <span>Dedicated founding team with relevant expertise.</span>
                                </li>
                                <li className="grid grid-cols-[20px_1fr] gap-2 items-start">
                                    <CheckCircle className="w-5 h-5 text-[#3CA2E2]" />
                                ...
                                <li className="grid grid-cols-[20px_1fr] gap-2 items-start">
                                    <CheckCircle className="w-5 h-5 text-[#3CA2E2]" />
                                    <span>Early stage of business development (pre-revenue or early revenue).</span>
                                </li>
                            </ul>
                        </motion.div>
                    </div>
            ...
            >
                ...
                >
                    How Abtik Helps You Secure Seed Funding
                </h2>
            ...
            >
                ...
                >
                    Why Choose Abtik for Seed Funding
                </h2>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
