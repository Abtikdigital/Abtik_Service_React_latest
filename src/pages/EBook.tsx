...
const Ebook: React.FC = () => {
 ...
 return (
  <HeadProvider>
   <Title>
    {seoData?.eBooks?.title || "Download Our Free eBooks Abtik Startup Advisor pvt ltd Team"}
   </Title>
   <Meta
    name="description"
    content={
   ...
   <Meta
    ...
    content={
     ...
     "ebooks, business financing, CGTMSE, startup growth, loan applications, Abtik Startup Advisor pvt ltd Team"
    }
   />
   <Meta
    name="robots"
   ...
   <MainLayout>
    <motion.section
     ref={refHero}
     className="flex justify-center items-center h-[70vh] sm:h-[80vh] lg:h-[85vh] xl:h-[80vh] 2xl:h-[75vh] lg:justify-end bg-center bg-cover w-full max-w-[1920px] mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-14 relative overflow-hidden"
    ...
    >
     <div className="w-full max-w-[1920px] mx-auto px-7 md:px-14 flex flex-col lg:flex-row gap-8 items-stretch">
     {/* <motion.div
