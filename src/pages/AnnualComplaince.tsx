    ...
    const faq = [
        {
            ...
            answer: "Annual compliance is the mandatory set of filings, disclosures, and statutory meetings companies and LLPs must complete each financial year as per Companies Act, LLP Act, and allied laws—including ROC filings, AGM, and financial statements."
        },
        {
            question: "2. Who is required to do annual compliance?",
            answer: "All Private Limited Companies, OPCs, LLPs, and Section 8 (NGO) companies registered in India—even those with zero turnover—must do annual filings with the Registrar of Companies (ROC) and other regulators."
        },
        {
            question: "3. What are the key annual compliances?",
            answer: "Key filings are: Board meetings, Maintaining statutory registers, Preparing and approving financials, Holding AGM, ROC returns (AOC-4, MGT-7/7A, LLP-11, LLP-8), Income tax return, KYC of directors, and additional event-based filings."
        },
        {
            question: "4. What documents and records are needed?",
            answer: "Financial statements, audited accounts, board/AGM resolutions/minutes, directors' KYC, statutory registers, and, for LLP, the Statement of Account & Solvency. Professional digital signatures are required for e-filing."
        },
        {
            question: "5. What are the penalties for non-compliance?",
            answer: "Heavy late fees (₹100/day even for small delays), disqualification of directors/partners, deregistration or striking off by MCA, and in certain cases prosecution and personal liability for officers."
        },
        {
            question: "6. How does Abtik assist with annual compliance?",
            answer: "Abtik provides end-to-end annual compliance: compliance calendar, secretarial help, document prep, digital signature, e-filing, AGM/board meeting support, ROC/ITR filings, and regular alerts to guarantee 100% legal standing."
        }
    ];
    ...
    const processData = [
        {
            ...
            description: "We gather and check all business records, financials, and statutory registers for accuracy and completeness for the annual period."
        },
        {
            icon: Shield,
            title: "Meeting, Notice & Resolution Support",
            description: "Our team drafts board/AGM notices, resolutions, prepares minutes, and coordinates required statutory meetings on your behalf."
        },
        {
            icon: Award,
            title: "ROC e-Filings & ITR Submission",
            description: "Your dedicated expert completes all e-filings (AOC-4/MGT-7/LLP-11/8, DPT-3, KYC, etc.) and Income Tax Return to keep your company/LLP fully compliant annually."
        }
    ];
    ...
    const benefitsData = [
        {
            ...
            description: "Avoid late fees, director disqualification, and company strike off with timely, accurate annual filings."
        },
        {
            icon: DollarSign,
            title: "Attract Investment & Bank Funding",
            description: "Proper compliance/filings open access to credit, grants, and investor due diligence for growth."
        },
        {
            icon: Shield,
            title: "Business Legitimacy & Brand Value",
            description: "Show clients, partners, and government your company is active, legitimate, and trustworthy."
        },
        {
            icon: Users,
            title: "Peace of Mind",
            description: "Year-round reminders, secretarial help, and expert guidance mean stress-free compliance."
        },
        {
            icon: Award,
            title: "Ready for Tenders & Global Business",
            description: "Only compliant companies are eligible for government tenders, FDI, overseas business, and major corporate contracts."
        }
    ];
    ...
    return (<>
        ...
        <Mainlayout>
            ...
            <motion.section
                ...
                >
                    <img loading="lazy" src={Image1} alt="Annual Compliance Illustration"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        >
                            ...
                            <ul className="space-y-2 text-sm text-gray-600">
                                <li className="grid grid-cols-[20px_1fr] gap-2 items-start"><CheckCircle className="w-5 h-5 text-[#3CA2E2]" /><span>Pvt Ltd, Limited, One Person, and Section 8 Companies</span></li>
                                <li className="grid grid-cols-[20px_1fr] gap-2 items-start"><CheckCircle className="w-5 h-5 text-[#3CA2E2]" /><span>Limited Liability Partnerships (LLP)</span></li>
                                <li className="grid grid-cols-[20px_1fr] gap-2 items-start"><CheckCircle className="w-5 h-5 text-[#3CA2E2]" /><span>Zero-turnover, dormant, and brand-new companies</span></li>
                                <li className="grid grid-cols-[20px_1fr] gap-2 items-start"><CheckCircle className="w-5 h-5 text-[#3CA2E2]" /><span>Must comply every year, irrespective of business done</span></li>
                            </ul>
                        </motion.div>
                        <motion.div
                            initial={{ y: 50, opacity: 0 }}
                        ...
                        >
                            ...
                            <ul className="space-y-2 text-sm text-gray-600">
                                <li className="grid grid-cols-[20px_1fr] gap-2 items-start"><CheckCircle className="w-5 h-5 text-[#3CA2E2]" /><span>Hold Board meetings & AGM</span></li>
                                <li className="grid grid-cols-[20px_1fr] gap-2 items-start"><CheckCircle className="w-5 h-5 text-[#3CA2E2]" /><span>Maintain statutory registers</span></li>
                                <li className="grid grid-cols-[20px_1fr] gap-2 items-start"><CheckCircle className="w-5 h-5 text-[#3CA2E2]" /><span>Prepare and approve financial statements</span></li>
                                <li className="grid grid-cols-[20px_1fr] gap-2 items-start"><CheckCircle className="w-5 h-5 text-[#3CA2E2]" /><span>File ROC forms: AOC-4, MGT-7/7A, DIR-3 KYC, DPT-3, LLP-11, LLP-8, etc.</span></li>
                                <li className="grid grid-cols-[20px_1fr] gap-2 items-start"><CheckCircle className="w-5 h-5 text-[#3CA2E2]" /><span>Income Tax Return for company/LLP</span></li>
                            </ul>
                        </motion.div>
                    </div>
                </div>
