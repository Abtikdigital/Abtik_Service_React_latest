...
import { blogsData, type BlogData } from "../data/blogsData";
...
const ExpandedBlog = () => {
 ...
 const listedBlogs = blogsData.filter((b) => b.showInNewBlogList !== false);
   ...
   >
    ...
    >
     ...
     >
      ...
      Management to Legal Compliance, We've Got You Covered at Abtik Startup Advisor pvt ltd Team
     </p>
