...
import Image1 from "../assets/MSMECertificate/Image1.jpeg";
import {
    Mail,
    MapPin,
    Phone,
    ...
    const benefitsData = [
        {
            ...
            description: "Easier access to collateral-free and subsidized loans via government schemes and banks[4][6][8][9].",
        },
        {
            icon: Award,
            title: "Patent & Trademark Subsidy",
            description: "Up to 50% cost reduction for patent/trademark filings, plus expert IP facilitation[4][8][9].",
        },
        {
            icon: Users,
            title: "Tender Preference",
            description: "Preference and relaxed norms for government tenders and procurement contracts[4][8].",
        },
        {
            icon: DollarSign,
            title: "Direct Subsidies",
            description: "Tax reductions, technology upgradation support, special grants for new and existing MSMEs[8][14].",
        },
        {
            icon: Shield,
            title: "Delayed Payment Protection",
            description: "Legal backing to ensure buyers pay MSMEs promptly, plus interest for overdue invoices[6][8].",
        },
    ];
    ...
    return (
        <>
            ...
            <HeadProvider>
                ...
                <Meta name="description" content={seoData?.msmeCertificateService?.description} />
                <Meta name="keyword" content={seoData?.msmeCertificateService?.keyword} />
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            >
                                ...
                                <ul className="space-y-2 text-sm text-gray-600">
                                    ...
                                    <li className="grid grid-cols-[20px_1fr] gap-2 items-start">
                                        <CheckCircle className="w-5 h-5 text-[#3CA2E2]" />
                                        <span>
                                            Investment &amp; turnover as per MSME norms:
                                            Micro: up to ₹1Cr &amp; ₹5Cr; Small: up to ₹10Cr &amp; ₹50Cr; Medium: up to ₹50Cr &amp; ₹250Cr.
                                        </span>
                                    </li>
                                    <li className="grid grid-cols-[20px_1fr] gap-2 items-start">
                                        <CheckCircle className="w-5 h-5 text-[#3CA2E2]" />
                            ...
                            >
                                ...
                                <ul className="space-y-2 text-sm text-gray-600">
                                    ...
                                    <li className="grid grid-cols-[20px_1fr] gap-2 items-start">
                                        <CheckCircle className="w-5 h-5 text-[#3CA2E2]" />
                                        <span>Download anytime, accessible for all verification</span>
                                    </li>
                                    <li className="grid grid-cols-[20px_1fr] gap-2 items-start">
                                        <CheckCircle className="w-5 h-5 text-[#3CA2E2]" />
                                    ...
                                    <li className="grid grid-cols-[20px_1fr] gap-2 items-start">
                                        <CheckCircle className="w-5 h-5 text-[#3CA2E2]" />
                                        <span>Enables you to access all eligible MSME incentives</span>
                                    </li>
                                </ul>
                            </motion.div>
                        </div>
