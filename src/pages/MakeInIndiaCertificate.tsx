...
const MakeInIndiaCertificate = () => {
    ...
    const processData = [
        ...
        },
        {
            ...
            description: "Attach with GeM/tender bid and get government purchase preference, incentives, and benefits as a certified Make in India supplier."
        }
    ];
        ...
        <Mainlayout>
            ...
            >
                ...
                >
                    ...
                    loading="lazy"
                        src={Image1}
                        alt="Make in India Certificate Illustration"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        >
                            ...
                            <ul className="space-y-2 text-sm text-gray-600">
                                ...
                                <li className="grid grid-cols-[20px_1fr] gap-2 items-start">
                                    <CheckCircle className="w-5 h-5 text-[#3CA2E2]" />
                                    <span>Local content: Class-I (50%+), Class-II (20-50%)</span>
                                </li>
                                <li className="grid grid-cols-[20px_1fr] gap-2 items-start">
                                    <CheckCircle className="w-5 h-5 text-[#3CA2E2]" />
                        ...
                        >
                            ...
                            <ul className="space-y-2 text-sm text-gray-600">
                                ...
                                <li className="grid grid-cols-[20px_1fr] gap-2 items-start">
                                    <CheckCircle className="w-5 h-5 text-[#3CA2E2]" />
                                    <span>Self-certification (usual case) or CA-certified (high value)</span>
                                </li>
                                <li className="grid grid-cols-[20px_1fr] gap-2 items-start">
                                    <CheckCircle className="w-5 h-5 text-[#3CA2E2]" />
